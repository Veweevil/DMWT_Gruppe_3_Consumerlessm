...
export default function Impressum() {
  return (
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col text-center items-center justify-center px-4">
        <Header />
      <div className="w-[800px] bg-white shadow-md rounded-lg p-6">
